    ...
    for i, pack in enumerate(train_loader, start=1):
        for rate in size_rates:
            ...
            with torch.backends.cuda.sdp_kernel(enable_math=False):
                P1_tea = torch.nn.functional.scaled_dot_product_attention(P1_tea, P1_tea, P1_tea)/temperature
                P2_tea = torch.nn.functional.scaled_dot_product_attention(P2_tea, P2_tea, P2_tea)/temperature
            ...
            kd_P1 = kl_loss(P1_stu, P1_tea)
            kd_P2 = kl_loss(P2_stu, P2_tea)
            
            distill_loss = (kd_P1 + kd_P2)*temperature**2            
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_save', type=str,
                        default='./model_pth/PolypPVTKD/'+model_name+'/')
